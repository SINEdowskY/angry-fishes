...
class Block extends FlxNapeSprite{
     ...
     * @param rotate Rotacja bloku, default `rotate` = 0
     */
    private var blockHP:Float;
    public function new(positionX:Float, positionY:Float, blockGraphic:FlxGraphicAsset, blockBreakingAnimation:Bool = true, blockWidth:Int, blockHeight:Int, blockMaterial:Material, _blockHP:Float, rotate:Float = 0){
        super();
